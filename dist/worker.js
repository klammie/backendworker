...
const redisClient_1 = require("./redisClient"); // ✅ Centralized Redis Client
// ✅ Initialize Worker Correctly
const worker = new bullmq_1.Worker("trade-queue", (job) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // ✅ Instead of setInterval, use a proper delay within BullMQ
    yield new Promise(resolve => setTimeout(resolve, interval));
    // ✅ Process trade after delay
    yield (0, tradeProcessor_1.processTrade)(accountId);
}), { connection: redisClient_1.redisClient });
// ✅ Event Handlers for Job Completion & Errors
worker.on("completed", (job) => {
    console.log(`Trade job ${job.id} completed successfully`);
});
worker.on("failed", (job, err) => {
    console.error(`Trade job ${job === null || job === void 0 ? void 0 : job.id} failed:`, err);
});
// ✅ Graceful Shutdown Handling for Worker & Redis
